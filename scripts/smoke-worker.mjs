...
const checks = [
  ...
  { path: "/topics/free-ai-tools", status: 200, type: "text/html", includes: "免费 AI 工具推荐" },
  { path: "/topics/not-a-real-topic", status: 404 },
  { path: "/sitemap.xml", status: 200, type: "application/xml", includes: "/topics/free-ai-tools" },
